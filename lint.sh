...
name="gracenode-server";
cwd=`pwd`;
# list directories/files to lint
list=();
defaultDirList="index.js controller.js error.js headers.js hook.js http.js https.js mime.js queryData.js request.js resource.js response.js router.js";
